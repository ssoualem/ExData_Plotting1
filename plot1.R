...
GeneratePlot1 <- function(file = defaultFileName, minDate = plotMinDate, maxDate = plotMaxDate) {
	...
	hist(powerSubset$globalActivePower, main = "Global Active Power", xlab = "Global active Power (kilowatts)", col= "red")
	dev.off()
}