...
GeneratePlot3 <- function(file = defaultFileName, minDate = plotMinDate, maxDate = plotMaxDate) {
	...
	plot(powerSubset$dateTime, powerSubset$subMetering1, col = "black", type = "l", xlab = "", ylab = "Energy sub metering")
	lines(powerSubset$dateTime, powerSubset$subMetering2, col = "red")
	lines(powerSubset$dateTime, powerSubset$subMetering3, col = "blue")
